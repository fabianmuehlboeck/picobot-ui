...
//function ActionToStr(action: IAction): string {
//    switch (action) {
//        case Action.Stay:
//            return "X";
//        case Action.North:
...
//    constructor(worldstates: AWorldState[], action: IAction, nextState: AState, comments: string[]) {
...
//                    }
//                }
//                var action: IAction = rule.getAction();
