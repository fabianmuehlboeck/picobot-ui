var State = /** @class */ (function () {
    function State(name, parent) {
        ...
        this.menuItem.firstChild.innerText = this.name;
    ...
    State.prototype.collapse = function () {
        if (!this.div.classList.contains("collapsed")) {
            this.div.classList.add("collapsed");
            //$(this.body).hide("drop", { direction: "down" }, "slow");
        }
    };
    State.prototype.toggleVisibility = function () {
        if (this.div.classList.contains("collapsed")) {
            this.expand();
        }
        else {
    ...
    State.prototype.addRule = function () {
        var rule = new Rule(this);
        this.rules.push(rule);
