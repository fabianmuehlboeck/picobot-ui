...
function FieldStateContains(l, r) {
    if (l == FieldState.Unknown) {
        return true;
    }
    return l == r;
}
function WorldStateContains(l, r) {
...
function FieldStatesMergeable(l, r) {
...
var AWorldState = /** @class */ (function () {
    function AWorldState(north, east, west, south) {
        if (north === void 0) { north = AFieldState.Empty; }
        if (east === void 0) { east = AFieldState.Empty; }
        if (west === void 0) { west = AFieldState.Empty; }
        if (south === void 0) { south = AFieldState.Empty; }
